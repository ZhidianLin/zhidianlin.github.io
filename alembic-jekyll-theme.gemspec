...
Gem::Specification.new do |spec|
  ...
  spec.version       = "4.1.0"
  spec.authors       = ["Zhidian Lin"]
  spec.email         = ["creado@foxmail.com"]

  spec.summary       = %q{Happy to meet you here.}
  spec.description   = "alembic-jekyll-theme"
  spec.homepage      = "https://zhidianlin.github.io"
  spec.license       = "MIT"
